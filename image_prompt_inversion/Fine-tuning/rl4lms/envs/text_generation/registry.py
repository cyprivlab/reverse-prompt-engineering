...
from rl4lms.envs.text_generation.reward import (
    ...
    ModifyBERTScoreRewardFunction,
    ModifyBLEURewardFunction,
)
...
class RewardFunctionRegistry:
    _registry = {
        ...
        "cos_similarity": CosineSimilarityReward,
        'modifyBert':ModifyBERTScoreRewardFunction,
        'modifyBLEU':ModifyBLEURewardFunction,
    }
